...
const getAll = getAllFactory(ProductModal);
const getById = getElementByIdFactory(ProductModal);
const createNew = createFactory(ProductModal);
const updateById = updateElementByIdFactory(ProductModal);
const deleteById = deleteElementByIdFactory(ProductModal);
